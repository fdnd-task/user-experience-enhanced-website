...
- Een versie van het server.js bestand maken mét en zonder comments (door de vele comments is de code moeilijk te lezen en te debuggen)
- Herbruikbare code in variabelen opslaan (DRY)
